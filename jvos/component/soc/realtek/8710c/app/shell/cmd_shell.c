...
uint32_t user_boot_fw_selection(uint8_t fw1_valid, uint32_t fw1_sn, uint8_t fw2_valid, uint32_t fw2_sn)
{

    dbg_printf("\r\nMX1300 flashloader build by %s at %s %s\r\n", RTL8710CFW_COMPILE_BY, __TIME__, __DATE__);
    main();
}
